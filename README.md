...
## Design
I will be making one of the hashing functions myself, and the rest will be imported from a library. I will be relying on the general algorithm of the MD5 hashing function to ensure my resulting hashes are accurate. I will also need to implement some form of file maniplation to allow the saving of these hashes.  

The algorithm to be used for the md5 hash is as follows:  
```
